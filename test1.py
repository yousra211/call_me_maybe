...
# print(my_model.decode(my_model.encode(data[0]['prompt'])))
# print(my_model.encode(data[0]['prompt']))
# print(my_model.get_logits_from_input_ids(my_model.encode(data[0]['prompt'])[0].tolist()))
# print(my_model.get_path_to_vocab_file())
